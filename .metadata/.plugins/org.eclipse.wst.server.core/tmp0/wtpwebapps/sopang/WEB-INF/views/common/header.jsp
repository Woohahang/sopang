...
<script type="text/javascript">
	...
	function mypage() {
		if (${sessionScope.memberInfo == null}) {
			alert('로그인 페이지로 이동합니다.');
			window.location.href = '${contextPath}/member/login.do';
		} else {
			window.location.href = '${contextPath}/mypage/listMyOrderHistory.do';
		}
	}
		...
		<div class="container">
			<div class="row">
				<div
					...
					<a href="#"
						class="mySopang text-decoration-none samll d-flex flex-column px-2 text-center ps-3 mt-2" onclick="mypage()" >
